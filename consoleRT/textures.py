...
# stones
stoneT = loadTexture(r"txtrs/stone/stone.txt")
coalT = loadTexture(r"txtrs/stone/coal.txt")
brightStoneT = loadTexture(r"txtrs/stone/brightStone.txt")
brightCoalT = loadTexture(r"txtrs/stone/brightCoal.txt")
brightIronT = loadTexture(r"txtrs/stone/brightIron.txt")
brightQuartzT = loadTexture(r"txtrs/stone/brightQuartz.txt")
ironT = loadTexture(r"txtrs/stone/iron.txt")
quartzT = loadTexture(r"txtrs/stone/quartz.txt")
